...
#criterio (1- empleados, 2- staff de tecnologías de la información “TI”, 3- gerente),
cola_prioridad = Heap(10)

arribo(cola_prioridad, 'Juan', 1)
arribo(cola_prioridad, 'Pedro', 1)
arribo(cola_prioridad, 'Manuel', 1)

print(atencion(cola_prioridad)[1])

arribo(cola_prioridad, 'Pepe', 2)
arribo(cola_prioridad, 'Jose', 2)
arribo(cola_prioridad, 'Gerente', 3)

print(atencion(cola_prioridad)[1])
print(atencion(cola_prioridad)[1])

arribo(cola_prioridad, 'Mariano', 1)
arribo(cola_prioridad, 'Federico', 1)
arribo(cola_prioridad, 'Homero', 3)
